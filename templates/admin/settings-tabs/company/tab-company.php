...
<div id="tab-company-content" class="myd-tabs-content myd-tabs-content--active">
	...
	<table class="form-table">
		<tbody>
			...
			<tr>
				<th scope="row">
					<label for="myd-currency-conversion-enabled"><?php esc_html_e( 'Conversión USD → VEF', 'myd-delivery-pro' );?></label>
				</th>
				<td>
					<input type="checkbox" name="myd-currency-conversion-enabled" id="myd-currency-conversion-enabled" value="1" <?php checked( get_option('myd-currency-conversion-enabled'), '1' ); ?>>
					<label for="myd-currency-conversion-enabled"><?php esc_html_e( 'Habilitar conversión automática de USD a Bolívares Venezolanos', 'myd-delivery-pro' );?></label>
					<p class="description">
						<?php esc_html_e( 'Cuando está habilitado, los precios de los productos mostrarán tanto los montos en USD como en VEF usando la tasa de cambio oficial de DolarAPI Venezuela. Las tasas de cambio se actualizan cada hora.', 'myd-delivery-pro' );?>
						<br>
						<strong><?php esc_html_e( 'Nota:', 'myd-delivery-pro' );?></strong> <?php esc_html_e( 'Esta función requiere una conexión a internet para obtener las tasas de cambio actuales.', 'myd-delivery-pro' );?>
					</p>
				</td>
			</tr>
